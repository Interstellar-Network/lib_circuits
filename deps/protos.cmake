...
set(_PROTOBUF_PROTOC $<TARGET_FILE:protobuf::protoc>) # ALTERNATIVE? "${Protobuf_PROTOC_EXECUTABLE}"
...
function(compile_proto_cpp SRC_PROTO_PATH)
    ...
    add_custom_command(
        ...
        ARGS --cpp_out "${CMAKE_BINARY_DIR}/protos/" -I "${hw_proto_path}" "${hw_proto}"
        DEPENDS "${hw_proto}")

    set(PROTO_GENERATED_CPP "${PROTO_GENERATED_CPP};${hw_proto_srcs};" PARENT_SCOPE)

    # DIRECTORY "${CMAKE_BINARY_DIR}/protos/"
    set_source_files_properties("${hw_proto_srcs}" PROPERTIES COMPILE_OPTIONS "-Wno-error;")
    set_source_files_properties("${hw_proto_hdrs}" PROPERTIES COMPILE_OPTIONS "-Wno-error;")
...
target_compile_options(interstellar_protos
    INTERFACE

    # google/protobuf/port.h:46:41: error: unused parameter 'size
